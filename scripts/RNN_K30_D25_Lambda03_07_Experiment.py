"""Same as RNN_K30_D10_Lambda03_07_Experiment.py, but at d=25: RNN, K-1=30,
lambda in {0.3, 0.7}, 40 reps (0-39, same seed formula). At d=25 these give
df(lambda)~8.93 and ~5.58 respectively (vs d=10's ~6.50/~4.28 -- the same raw
lambda maps to a different df per dimension, as established earlier).

Run: python -m scripts.RNN_K30_D25_Lambda03_07_Experiment
"""
import functools
import os
import time
...
CSV_PATH = os.path.join(os.path.dirname(__file__), "..", "results", "rnn_k30_d25_lambda03_07_experiment.csv")
...
if __name__ == "__main__":
    print(f"K-1=30, d=25, lambda in {LAMBDA_VALUES}, reps 0-39")
    base_row = _base_row()
