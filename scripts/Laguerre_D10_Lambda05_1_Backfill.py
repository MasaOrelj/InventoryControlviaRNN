...
lambda in {0.5, 1.0} (see conversation) -- brings these two cells to 40 reps,
matching the depth used elsewhere for stability checks (K-1=30, K-1=10 RNN
backfills). Same market/contract/basis/seeds as Laguerre_Ridge_Lambda_Experiment.py,
just narrowed to this one dimension and these two lambdas, reps 10-39 only.

Run: python -m scripts.Laguerre_D10_Lambda05_1_Backfill
"""
import functools
import os
import time
